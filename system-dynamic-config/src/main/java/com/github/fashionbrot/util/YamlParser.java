...
public class YamlParser {
    ...
    private static void buildMultilayerMap(Map<String, Object> parent, String path,Object value) {
        ...
        if (key.endsWith("]")) {
            ...
            List<Object> childList =  buildChildList(parent, listKey);
            buildMultilayerList(childList, listPath, value);
        }else{
            if (keys.length == 1) {
    ...
    private static void buildMultilayerList(List<Object> parent,String path,Object value) {
        ...
        if (keys.length == 1) {
            ...
            String newPath = path.substring(path.indexOf(".") + 1);
            Map<String, Object> childMap = buildChildMap(parent, index);
            if (CollectionUtil.isNotEmpty(childMap)){
                buildMultilayerMap(childMap, newPath, value);
            }
        }
    }
    ...
    private static Map<String, Object> bulidChlidMap(Map<String, Object> parent,String key){
        if (parent.containsKey(key)) {
            ...
            Map<String, Object> childMap = new LinkedHashMap<>(16);
    ...
    private static List<Object> buildChildList(Map<String, Object> parent,String key){
        if (parent.containsKey(key)) {
            ...
            List<Object> child = new ArrayList<>(16);
...
//        System.out.println(a.get("server.servlet.encoding.charset"));
        ...
        Yaml yaml = new Yaml();
        Map<String,Object> pp = yaml.load(content);
        Properties p =new Properties();
        p.putAll(b);

        System.out.println(p.get("spring.thymeleaf.prefix"));*/
