...
public class DataDynamicConsts {
    ...
    public static final String APP_CODE = "${mars.dynamic.app-code}";

    public static final String ENV_CODE = "${mars.dynamic.env-code}";

    public static final String SERVER_ADDRESS = "${mars.dynamic.http.server-address}";
    ...
    public static final String CLUSTER = "mars.dynamic.cluster";
}
